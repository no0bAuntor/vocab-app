...
// import allWords from "../../data/phase1/vocabulary-words.json";
// import WordCard from "../../components/WordCard";

// export default function Home({ isDarkMode, toggleDarkMode }) {
//   const words = allWords.slice(0, 10); // Only use first 10 words for Phase 1
...
//   const totalWords = words.length; // Will be 10
...
function Phase1Home({ isDarkMode, toggleDarkMode }) {
  const [words] = useState(phase1Words.slice(0, 10)); // Only use first 10 words for Phase 1
  const [currentIndex, setCurrentIndex] = useState(0);
  const [swipeDistance, setSwipeDistance] = useState(0);
  const [isSwipeActive, setIsSwipeActive] = useState(false);
  const [cardTransition, setCardTransition] = useState(false);
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-6">
              ...
              <p className={`text-sm md:text-base ${
                ...
                Words 1-10 • Master advanced vocabulary
              </p>
            </div>
