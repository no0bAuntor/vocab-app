...
function Phase3Home({ isDarkMode, toggleDarkMode }) {
  const [words] = useState(phase3Words);
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className={`text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r ${
            ...
            📚 Phase 3 - Vocabulary Master
          </h1>
          <p className={`text-base md:text-lg mb-2 ${
            isDarkMode ? 'text-gray-300' : 'text-gray-600'
          }`}>
            Master words 21-30 with interactive word cards
          </p>
        </div>
